...
{
  connect (&TcpManager::instance (), &TcpManager::progress, this,
...
QString Controller::generatorUuid () { return QUuid::createUuid ().toByteArray ().toHex (); }
...
void Controller::insertItem (QString msg_id, QQuickItem *item)
{
  ...
  connect (item, &QQuickItem::destroyed, this, [] () { qInfo () << "Quick Item Destroyed"; });
